      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {currentUser.isAdmin && (
          <Link to={"/create-post"}>
            <button
              type="button"
              className="text-white bg-gradient-to-br from-green-300 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full border-2 border-slate-500 me-2 mb-2"
            >
              Create a Post
            </button>
          </Link>
