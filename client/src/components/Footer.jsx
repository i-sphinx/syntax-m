...
function Footer() {
  return (
    <footer className="border-t-2 py-4 sm:py-8 text-sm sm:text-base font-medium bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          ...
          {/* Element 3 */}
          <div className="flex justify-center sm:justify-end border-t-2 sm:border-none pt-2 sm:pt-0">
